    ...
    >
      <div className="w-[180px] flex justify-center gap-2 items-center relative font-bold p-1 rounded">
        <div
          ...
          className="w-full text-center bg-lime-400 rounded py-2 shadow-md"
        >
          {a}
        </div>
        <div
          style={{ backgroundColor: b, color: a }}
          className="w-full text-center bg-lime-400 rounded py-2 shadow-md"
        >
          {b}
        </div>
      ...
      <div
        style={{ background: bg }}
        className="w-full rounded font-bold p-2 text-center text-[8px] shadow-md"
      >
        {bg}
      </div>
    </Link>
